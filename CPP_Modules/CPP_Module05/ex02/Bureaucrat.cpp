...
void Bureaucrat::signForm(AForm &form)
{
	...
	{
		std::cerr << this->getName() << " was not able to sign the Form " << form.getName() << ": " << e.what() << "\033[0m" << std::endl;
	}
}
...
void Bureaucrat::executeForm(AForm const &form)
{
	...
	{
		std::cerr << this->getName() << " was not able to exececute the Form " << form.getName() << ": " << e.what() << "\033[0m" << std::endl;
	}
}

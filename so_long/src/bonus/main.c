...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/08 22:08:08 by lmarchai          #+#    #+#             */
/*   Updated: 2023/01/24 15:37:34 by lmarchai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	incr_frame(data);
	if (data->frame % 7500 == 0 && data->map.enemies != NULL)
	{
		get_next_pos(data);
